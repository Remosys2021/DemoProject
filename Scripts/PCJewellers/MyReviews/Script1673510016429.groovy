...
WebUI.click(findTestObject('Object Repository/PNG/Page_Account  Gold  Diamond  Online Jewelle_3bdbfd/a_My Reviews'))

WebUI.click(findTestObject('Object Repository/PNG/Page_Account Information  My Reviews/a_WelcomeRemo1'))

WebUI.click(findTestObject('Object Repository/PNG/Page_Account Information  My Reviews/a_Logout'))
